...
public class AppTest {
    ...
    public void testCase1() throws Exception
    {
        ...
        WebElement resultText = driver.findElement(By.xpath("/html/body/div[2]/main/div[1]/h1/span"));
            if (resultText.getText().contains("Search results for: 'Shoe'")) {
                ...
                FileUtils.copyFile(screenshot, new File("C:\\Users\\suren\\OneDrive\\Desktop\\Selenium\\magento\\target\\search_results_shoe.png"));
            }
    ...
    public void testCase2() throws Exception
    {
        ...
        WebElement resultText = driver.findElement(By.xpath("/html/body/div[2]/main/div[1]/h1/span"));
            if (resultText.getText().contains("Search results for: 'Hoodie'")) {
                System.out.println("Search results verified.");
                File screenshot = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
                FileUtils.copyFile(screenshot, new File("C:\\Users\\suren\\OneDrive\\Desktop\\Selenium\\magento\\target\\search_results_Hoodie.png"));
            }
    ...
    public void testCase3() throws Exception
    {
        ...
        if (resultText.getText().contains("Qty")) {
            ...
            File screenshot = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
            FileUtils.copyFile(screenshot, new File("C:\\Users\\suren\\OneDrive\\Desktop\\Selenium\\magento\\target\\search_results_Quantity.png"));
        }
